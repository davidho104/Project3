...
function ResourcesPage({ children }) {
        return (
                <div>
                        ...
                        <br />
                        <h2>OFFICE SUPPLIES</h2>
                        <p>While the company normally frowns on theft our supervisor has secretly given us the go-ahead to steal Peter’s pens as often as we can. If you need something other than pens than try stealing it from Edward, he always has the best stuff.  If some of your own office supplies go missing that is most likely Carl, a former employee named Carl who has been living in the building’s ventilation ducts for years.</p>
                        <p>Be careful when you sit down that there aren’t any pencils and pens stabbed into your office chair.  The office is built on a Native American burial ground.  We think the ghosts are trying to tell us something.</p>
                        <p>The blood stains are under my desk belong to your predecessor Kevin.</p>
                        <p>For more information see</p>
                        <a href="https://www.dunder-mifflin/kevin-killed-himself">https://www.dunder-mifflin/kevin-killed-himself</a>

                        <br />
                        <br />
                        <h2>TEAMWORK</h2>
                        <p>You may be wondering why you are never invited to join your coworkers for lunch?  This is because we want you to feel isolated and terrible.  But rest assured, when a new employee is hired will begin inviting you to join us so that we can make them feel isolated and terrible.</p>

                        <p>Never be afraid to break down and cry when at work.  Believe us, it’s a common occurrence around here. </p>

                        <p>Cindy is always the best person to blame any a huge mistake on.  </p>

                        <p>When your boss complains about your co-workers always make sure you agree and offer supporting evidence.</p>

                        <p>You can only ask your coworkers to help three times you before they start to deliberately sabotage your effort.  </p>

                        <p>Sam Brannon loves to discuss you the personal life of co-workers, expect him to inform everyone about any detail you share within 24 hours.  </p>

                        <p>For more information see </p>
                        <a href="https://www.dunder-mifflin/sam-can-rot-in-hell">https://www.dunder-mifflin/sam-can-rot-in-hell</a>
                        <br />
                        <br />
                        <h2>HOURS</h2>
                        <p>The Work day officially ends at 5:00 pm, but if you go home then then you clearly you don’t care about this job.  But if you stay longer than 2 hours?  Dude, everyone has gone home! If an employee works late and nobody knows it, do you think they will get a raise?</p>
